							...
							<div class="row">
								<div class="col-sm-8">
									<a style="text-decoration: none; color: inherit;" href="students_view.php">
										<img src="resources/table_icons/application_view_columns.png">Exam Results</a>
								</div>
						</h1>
					</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover">
						<tr>
							...
							<th><a class="TableHeader">students</a></th>
							...
							<th><a class="TableHeader">Marks</a></th>
							<th><a class="TableHeader">Term</a></th>
