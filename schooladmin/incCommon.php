	...
	*/
	...
	function get_sql_from($table_name, $skip_permissions = false){
		$sql_from = array(   
			...
			'streams' => "`streams` ",
			'hostels' => "`hostels` ",
			'timetable' => "`timetable` LEFT JOIN `classes` as classes1 ON `classes1`.`id`=`timetable`",
			'events' => "`events` ",
			'notices' => "`notices` ",
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			...
			<div class="collapse navbar-collapse">
				...
				<?php if(getLoggedAdmin()){ ?>
					<ul class="nav navbar-nav">
						<a href="<?php echo PREPEND_PATH; ?>admin/pageHome.php" class="btn btn-default navbar-btn hidden-xs" title="<?php echo html_attr($Translation['admin area']); ?>"><i class="glyphicon glyphicon-cog"></i> <?php echo $Translation['admin area']; ?></a>
						<a href="<?php echo PREPEND_PATH; ?>admin/pageHome.php" class="btn btn-default navbar-btn visible-xs btn-lg" title="<?php echo html_attr($Translation['admin area']); ?>"><i class="glyphicon glyphicon-cog"></i> <?php echo $Translation['admin area']; ?></a>
					</ul>
				<?php } ?>
