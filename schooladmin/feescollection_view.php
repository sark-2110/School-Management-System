							...
							<div class="row">
								<div class="col-sm-8">
									<a style="text-decoration: none; color: inherit;" href="students_view.php">
										<img src="resources/table_icons/account_balances.png"> Fees Collection
									</a>
								</div>
						</h1>
					</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover">
						<tr>
							...
							<th><a class="TableHeader">Session</a></th>
							<th><a class="TableHeader">PaidAmount</a></th>
							<th><a class="TableHeader">Balance</a></th>
							<th><a class="TableHeader">Branch</a></th>
							<th><a class="TableHeader">Date</a></th>
							<th><a class="TableHeader">Remarks</a></th>
						</tr>
					<?php
