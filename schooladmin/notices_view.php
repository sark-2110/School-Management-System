							...
							<div class="row">
								<div class="col-sm-8">
									<a style="text-decoration: none; color: inherit;" href="students_view.php">
										<img src="resources/table_icons/document_layout.png">Notices</a>
								</div>
						</h1>
					</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover">
						<tr>
							...
							<th><a class="TableHeader">Details</a></th>
							<th><a class="TableHeader">Posted_By</a></th>
						</tr>
					<?php
